      ...
      {showForm && (
        <div ref={formRef} className="internship-form form-animation">
          ...
          <form className="form-box" onSubmit={handleSubmit}>
            ...
            <input type="text" name="name" value={form.value} onChange={handleInput} placeholder="Enter your full name" required />

            <label>Email Address</label>
            <input type="email" name="email" value={form.value} onChange={handleInput} placeholder="Enter your email" required />
            ...
            <textarea name="about" value={form.about} onChange={handleInput} placeholder="Tell me something more about you"></textarea>
